...
OrgFileName = "TestSound.txt";
DitheredFileName = "OutSound.txt";
DitheredWavName = "OutSound.wav";
TruncBits = 16;
...
z = z/(2**(TruncBits-1));       % this file has xx bits resolution
...
wavwrite(z, Fs, TruncBits, DitheredWavName);
